...
3. Recipient Twitter handle (must start with "@")
...
1. Identify the relevant information from the user's message:
   ...
   - Quote the part mentioning the recipient Twitter handle.
...
2. Validate each piece of information:
   ...
   - Twitter handle: Ensure it starts with "@" and is a valid username (e.g., no spaces or special characters other than "@").
...
- The recipient address must be a valid Twitter handle starting with "@".
